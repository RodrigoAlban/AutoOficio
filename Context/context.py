class TemplateContext:
	...
	def get_context(app_instance):
		...
		# Pega o dicionário de contexto da instância do app
		# Parâmetros:
		#   app_instance: Instância da classe AutoOficio

		# Retorna:
		#   dictionary: O dicionário de contexto
		...
		return {
			...
			#'DATA_ADMISSAO': app_instance.DATA_ADMISSAO.get(),
			#'DATA_DEMISSAO': app_instance.DATA_DEMISSAO.get(),
			#'ENDERECO_SEGURADO': app_instance.ENDERECO_SEGURADO.get(),
